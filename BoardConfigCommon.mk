...
# Partitions - dynamic
BOARD_SUPER_PARTITION_SIZE := 10127360000
...
# Reserve space in dynamic partitions
ifeq (,$(filter true,$(WITHOUT_RESERVED_SIZE) $(WITH_GMS)))
    ...
    # Reserved sizes
    BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 1810612736    # ~1.8 GB
    BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 309715200      # ~300 MB
    BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 309715200  # ~300 MB
else
#minimal reserve 55MB
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 55165824
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 55165824
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 55165824
endif

# minimal reserves for vendor/ODM
BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 55165824
BOARD_ODMIMAGE_PARTITION_RESERVED_SIZE := 55165824
...
ifneq ($(TARGET_IS_TABLET),true)
DEVICE_MANIFEST_FILE += $(COMMON_PATH)/configs/vintf/manifest_phone.xml
endif
